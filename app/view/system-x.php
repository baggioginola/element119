    ...
    <div id="mainContentSection">
        ...
        <div class="product-view">
            <div class="product-essential">
                <form id="product_addtocart_form" enctype="multipart/form-data" method="post" action="">
                ...
                <div class="topSection">
                    ...
                    <div class="videoSection">
                        <a rel="prettyPhoto" href="https://www.youtube.com/watch?v=QKSZvq-sKuY"
                           title="Stress Test: Saltwater Submersion">
                            <img alt="System X Application Video" src="<?php echo IMAGES; ?>saltwater.jpg">
                        </a>
                        <br>
                    </div>
                    <div class="videoSection">
                        <a rel="prettyPhoto" href="https://www.youtube.com/watch?v=9D6yAXWSm54"
                           title="Anti-Graffiti Test">
                            <img alt="Demonstration : Anti-Graffiti" src="<?php echo IMAGES; ?>anti-graffiti.jpg">
                        </a>
                        <br>
                    </div>
                    <div class="videoSection">
                        <a rel="prettyPhoto" href="https://www.youtube.com/watch?v=uYuLVQM16bU"
                           title="Dawn Wash Test Repeated 150 Times">
                            <img alt="Demonstration: 150x Detergent Wash" src="<?php echo IMAGES; ?>150xwash.jpg">
                        </a>
                        <br>
                    </div>
                    <div class="videoSection">
                        <a rel="prettyPhoto" href="https://www.youtube.com/watch?v=U6tTmMdtDwo"
                           title="System X Application Video">
                ...
                <div style="clear:both;">
                    ...
                    <div style="text-align:center;margin-top:50px;margin-bottom:350px;">
                        <div style="float:left;width:50%">
                            <span style="float:left;margin-left:25px">System X 65ml</span>
                            <img width="315" alt="System X 65ml Kit" src="<?php echo IMAGES; ?>Sysx_kit_65ml.jpg"
                                 style="display:inline;margin:10px">
                        </div>
                        <div style="float:left;width:50%">
                            <span style="float:left;margin-left:25px">System X 275ml</span>
                            <img width="315" alt="System X 275ml" src="<?php echo IMAGES; ?>Sysx_kit_325ml.jpg"
                                 style="display:inline;margin:10px">
                        </div>
                    </div>
