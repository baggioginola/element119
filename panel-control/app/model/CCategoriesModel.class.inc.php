...
class CategoriesModel extends Database
{
    ...
    public function getById($id = '')
    {
        ...
        $query = "SELECT id,nombre,key_nombre,descripcion, nombre_descripcion FROM " . self::$table . " WHERE id = '" . $id . "' ";
    ...
    public function getByName($name = '')
    {
        ...
        $query = "SELECT id,nombre FROM " . self::$table . " WHERE key_nombre = '" . $name . "' and active = true ";
